...
icon.addEventListener("click", function(){
 ...
 if($theloaiban=='tatcasanpham'){
    ?>
  - <span style="color: black; "><i class="fa fa-caret-down dropdown__caret"></i>
 <a href="https://thuocsi.vn/products" target="_blank" class="a"  style="color:#1250dc;">Thuocsi.vn</a></span> - <span style="color: black;">
 <i class="fa fa-caret-down dropdown__caret"></i>
 <a href="https://chosithuoc.com/" class="a" style="color:#1250dc;">Chosithuoc</a></span>- <span style="color: black;"><i class="fa fa-caret-down dropdown__caret"></i>
 <a href="https://www.nhathuocankhang.com/" class="a" style="color: #1250dc;">Ankhang.com</a></span> - <span style="color: black;"><i class="fa fa-caret-down dropdown__caret"></i>
 <a href="https://thuocsi.pharex.vn/products" class="a" style="color: #1250dc; ">Pharex.vn</a></span> - <span style="color: black;"><i class="fa fa-caret-down dropdown__caret"></i>
 <a href="https://nhathuoclongchau.com.vn/" class="a" style="color: #1250dc; ">Longchau.vn</a></span> - <span style="color: black;"><i class="fa fa-caret-down dropdown__caret"></i>
 <a href="https://www.pharmacity.vn/" class="a" style="color: #1250dc; ">Pharmacity.vn</a></span> - <span style="color: black;"><i class="fa fa-caret-down dropdown__caret"></i>
 <a href="https://www.medigoapp.com/" class="a" style="color: #1250dc; ">Medigoapp.com</a></span></h2>
  <?php
 ...
 <?php
    ...
    ?> - <span style="color: black; "><i class="fa fa-caret-down dropdown__caret"></i><a href="https://thuocsi.vn/products" target="_blank" class="a" style="color:#1250dc;">Thuocsi.vn</a></span></h2>
 <?php
 }elseif($theloaiban=='chosithuoc'){
    ?>
  - <span style="color: black; "> <i class="fa fa-caret-down dropdown__caret"></i>
 <a href="https://chosithuoc.com/" class="a" style="color:1250dc;">Chosithuoc</a></span> </h2>
 <?php
 }elseif($theloaiban=='ankhang'){
    ?>
 - <span style="color: black;"><i class="fa fa-caret-down dropdown__caret"></i> <a href="https://www.nhathuocankhang.com/" class="a" style="color: #1250dc;">Ankhang.com</a></span> </h2>
  <?php
...
- <span style="color: black;"><i class="fa fa-caret-down dropdown__caret"></i>
 ...
 <?php
    ...
    ?>
- <span style="color: black;"><i class="fa fa-caret-down dropdown__caret"></i>
 <a href="https://www.pharmacity.vn/" class="a" style="color: #1250dc; ">Pharmacity.vn</a></span></h2>
 <?php
...
<?php
    ...
    ?>
 - <span style="color: black;"><i class="fa fa-caret-down dropdown__caret"></i>
 <a href="https://thuocsi.pharex.vn/products" class="a" style="color: #1250dc; ">Pharex.vn</a></span></h2>
