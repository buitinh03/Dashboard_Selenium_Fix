                        ...
                        ?>
                            ...
                            <tbody>
                                    <tr onclick="handleClick(event)" id="tbody" class="tr" >
                                        ...
                                        <td style="align-items: center; text-align:center; margin: 0 auto; width: 5%; padding: 0 2px;" ><img src='<?php echo $set['photo'] ?>' style="width:40px;height: auto; text-align:center; margin: 0 auto;"></td>
                                        <?php ;}else{ ?>
