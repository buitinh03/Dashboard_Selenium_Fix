                        ...
                        <div class="adress-form-content">
                            <h2>Cào Dữ Liệu Website <span id="adress-close">X Đóng</span></h2><br>
                               ...
                               <label class="containerr" style="font-weight: 400;">Thuocsi.vn
                                ...
                                <label for="" class="warning" style="margin: 10px; padding: 10px;">Quá trình cào dữ liệu có thể mất khá nhiều thời gian, vui lòng chờ <a href="https://www.youtube.com/watch?v=WYduvea9Qgc" style="color:#2196F3;">Click</a></label>
                                <script>
