            ...
            try:
                ...
                try:
                    ...
                    if "Xuất xứ thương hiệu" in nuoc_san_xuat:
                        ...
                        nuoc_san_xuat_alt = driver.find_element(By.CSS_SELECTOR,
                                                                "tr.content-container:nth-child(7)").text
                    ...
                    nuoc_san_xuat = "không đề cập"
                try:
                    hamluong_thanhphan = driver.find_element(By.CSS_SELECTOR,
                                                                "tr.content-container:nth-child(4)").text
                ...
                try:
                    photo = driver.find_element(By.CSS_SELECTOR,
                                                ".swiper-slide-active .h-full > source").get_attribute(
                        "srcset")
                except NoSuchElementException:
                    photo = ""
